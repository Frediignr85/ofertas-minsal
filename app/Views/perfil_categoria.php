    ...
    <main id="main">
        <div class="container">
                    ...
                    <div class="title__container tabs">
                        <div class="section__titles category__titles ">
                            <div class="section__title filter-btn active" data-id="All Products">
                                <img src="http://localhost/promociones/assets/<?php echo $datos_categoria[0]['imagen_banner']; ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="title__container tabs">
                        <div class="section__titles category__titles ">
                            <div class="section__title filter-btn active" data-id="All Products">
                                <span class="dot"></span>
                                <h1 class="primary__title"><?php echo $datos_categoria[0]['nombre']; ?></h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="category__container" data-aos="fade-up" data-aos-duration="1200" style="margin: 50px;margin-left: 50%; margin-right: 50%;">
                <div class="category__center">
                    <a href="<?php echo base_url("/inicio/categorias") ?>" class="btn btn-success" style="width:100%">Volver</a>
                </div>
            </div>
            <div>
