                ...
                <nav class="nav">
                    ...
                    <div class="nav__menu">
                        ...
                        <ul class="nav__list">
                            ...
                            <li class="nav__item">
                                <a href="<?php echo base_url("/inicio/establecimientos"); ?>" class="nav__link">Establecimientos</a>
                            </li>
                            <li class="nav__item">
    ...
    <main id="main">
        <div class="container">
            ...
            <section class="category__section section" id="category">
                    ...
                    <div class="title__container tabs">
                        <div class="section__titles category__titles ">
                            <div class="section__title filter-btn active" data-id="All Products">
                                <img src="http://localhost/promociones/assets/<?php echo $datos_establecimiento[0]['imagen_banner']; ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="title__container tabs">
                        <div class="section__titles category__titles ">
                            <div class="section__title filter-btn active" data-id="All Products">
                                <span class="dot"></span>
                                <h1 class="primary__title"><?php echo $datos_establecimiento[0]['nombre']; ?></h1>
                            </div>
                        </div>
                    </div>
                ...
                <b>Pagina Web: </b><span><?php echo $datos_establecimiento[0]['url']; ?></span>
                <br>
                <b>Correo Electronico: </b><span><?php echo $datos_establecimiento[0]['correo']; ?></span>
                
                <div class="category__container" data-aos="fade-up" data-aos-duration="1200" style="margin-top:50px;">
            ...
            <div class="category__container" data-aos="fade-up" data-aos-duration="1200" style="margin: 50px;margin-left: 50%; margin-right: 50%;">
                <div class="category__center">
                    <?php
                        if($_SESSION['establecimientos']){
                    ?>
                        <a href="<?php echo base_url("/inicio/establecimientos/") ?>" class="btn btn-success" style="width:100%">Volver</a>
                    <?php
                        }
                        else{
                    ?>
                        <a href="<?php echo base_url("/inicio/perfil_categoria/".$datos_establecimiento[0]['id_categoria']) ?>" class="btn btn-success" style="width:100%">Volver</a>
                    <?php
                        }
                    ?>
                </div>
